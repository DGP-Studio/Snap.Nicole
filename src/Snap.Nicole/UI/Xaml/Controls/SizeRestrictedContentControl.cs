...
[GeneratedDependencyProperty<bool>("IsWidthRestricted", DefaultValue = true, NotNull = true)]
[GeneratedDependencyProperty<bool>("IsHeightRestricted", DefaultValue = true, NotNull = true)]
